...
### Glance 
Glance is another LXC which is a dashboard, I have it set up so that it automatically directs me to the page when opening a new tab in my web browser. Its very customizable allowing you to change pretty much whatever you want about it.
...
Another is [TrueNAS](https://www.truenas.com/) which unsurprisingly is Network Attached Storage, it also has a good UI design, it provides RAID for its disks and is a FOSS alternative to Unraid, if you really care about data storage this is a good option.
