...
<br>20/06 - I've added a passcode to the website. This is because I'm looking to add controls for certain things like WakePC using wake on lan. I don't know how to do some API stuff, so I'm using cloudflare worker bots which have a limit on the free tier. Need to do research into how to do APIs properly myself.