...
<br>19/05 - I've started work on the control pannel. The desgin has been made too look like my website. Same colours etc. Ive added buttons, the camera section, the stats and utilites sections. So far going well, will update with pictures when I'm happy.<br>
<br>20/05 - I've managed to get it working on the Ipad Air First generation with lots of diffculty. The ipad only has safari 12 making it vrey old and very limited in functionaility. Will keep updated with how it goes on. I am quite happy with the result however. 